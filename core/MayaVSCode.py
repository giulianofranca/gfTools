...
cmds.setAttr("arm_L_upperArmFK_ctrl.ARM", 0, l=True)
cmds.setAttr("arm_L_armIK_ctrl.ARM", 0, l=True)
snippets.createEnumAttribute("spaceSwitch", "spaceSwitch", {"Shoulder":0, "Chest":1, "Hip":2, "Root":3, "Global":4})
...
cmds.setAttr("arm_L_upperArmFK_ctrl.UPPERARM", 0, l=True)
snippets.createEnumAttribute("FOREARM", "FOREARM", {"__________":0})
cmds.setAttr("arm_L_forearmFK_ctrl.FOREARM", 0, l=True)
snippets.createEnumAttribute("WRIST", "WRIST", {"__________":0})
cmds.setAttr("arm_L_wristFK_ctrl.WRIST", 0, l=True)
...
cmds.setAttr("leg_L_legSnap_ctrl.SNAP", 0, l=True)
...
snippets.createUnitAttribute("twistKnee", "twistKnee", snippets.AttributeTypes.kAngle)
...
snippets.createNumericAttribute("squashMultThighFB", "squashMultThighFB", snippets.AttributeTypes.kFloat, minVal=0.001, default=1.0)
snippets.createNumericAttribute("squashMultThighLR", "squashMultThighLR", snippets.AttributeTypes.kFloat, minVal=0.001, default=1.0)
snippets.createNumericAttribute("squashMultShinFB", "squashMultShinFB", snippets.AttributeTypes.kFloat, minVal=0.001, default=1.0)
snippets.createNumericAttribute("squashMultShinLR", "squashMultShinLR", snippets.AttributeTypes.kFloat, minVal=0.001, default=1.0)
...
snippets.createUnitAttribute("thumbCurl", "thumbCurl", snippets.AttributeTypes.kFloat, default=0.0)
