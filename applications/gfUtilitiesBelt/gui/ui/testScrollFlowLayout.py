...
class ScrollFlowLayout(QtWidgets.QLayout):
    def __init__(self, parent=None, margin=0, spacing=-1):
        super(ScrollFlowLayout, self).__init__(parent)
    ...
    def setGeometry(self, rect):
        super(ScrollFlowLayout, self).setGeometry(rect)
