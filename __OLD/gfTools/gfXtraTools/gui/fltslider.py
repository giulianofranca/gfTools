...
# Form implementation generated from reading ui file 'fltslider.ui'
#
...
class Ui_widIntSlider(object):
    def setupUi(self, widIntSlider):
        ...
        self.txtIntSlider.setMinimumSize(QtCore.QSize(70, 0))
        self.txtIntSlider.setMaximumSize(QtCore.QSize(70, 16777215))
        ...
        self.sldIntSlider.setMinimumSize(QtCore.QSize(80, 0))
        self.sldIntSlider.setSingleStep(1)
    ...
    def retranslateUi(self, widIntSlider):
        ...
        self.lblIntSlider.setText(_translate("widIntSlider", "Float slider"))
