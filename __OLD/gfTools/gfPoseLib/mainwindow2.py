...
class Ui_MEUCU(object):
    def setupUi(self, MEUCU):
        MEUCU.setObjectName("MEUCU")
        MEUCU.resize(1042, 583)
        self.centralwidget = QtWidgets.QWidget(MEUCU)
        ...
        MEUCU.setCentralWidget(self.centralwidget)
        self.action_createFolder = QtWidgets.QAction(MEUCU)
        self.action_createFolder.setObjectName("action_createFolder")

        self.retranslateUi(MEUCU)
        QtCore.QMetaObject.connectSlotsByName(MEUCU)

    def retranslateUi(self, MEUCU):
        _translate = QtCore.QCoreApplication.translate
        MEUCU.setWindowTitle(_translate("MEUCU", "MEUCU"))
        self.treeWidget_folderList.headerItem().setText(0, _translate("MEUCU", "1"))
        __sortingEnabled = self.treeWidget_folderList.isSortingEnabled()
        self.treeWidget_folderList.setSortingEnabled(False)
        self.treeWidget_folderList.topLevelItem(0).setText(0, _translate("MEUCU", "A"))
        self.treeWidget_folderList.topLevelItem(0).child(0).setText(0, _translate("MEUCU", "TAMO AI"))
        self.treeWidget_folderList.topLevelItem(0).child(1).setText(0, _translate("MEUCU", "NA MACIOTA"))
        self.treeWidget_folderList.setSortingEnabled(__sortingEnabled)
        self.groupBox_pose.setTitle(_translate("MEUCU", "Pose"))
        self.button_snapShot.setText(_translate("MEUCU", "Icon"))
        self.label_poseLabel.setText(_translate("MEUCU", "Name"))
        self.button_blendValue.setText(_translate("MEUCU", "0"))
        self.button_save.setText(_translate("MEUCU", "Save"))
        self.action_createFolder.setText(_translate("MEUCU", "Create Folder"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    MEUCU = QtWidgets.QMainWindow()
    ui = Ui_MEUCU()
    ui.setupUi(MEUCU)
    MEUCU.show()
    sys.exit(app.exec_())
