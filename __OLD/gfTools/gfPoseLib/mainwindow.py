...
class Ui_PoseLibWin(MayaQWidgetDockableMixin, QtWidgets.QMainWindow):
    CONTROL_NAME = 'PoseLibWin'
    instances = list()

    def __init__(self):
        super(Ui_PoseLibWin, self).__init__()
        Ui_PoseLibWin.deleteInstances()
    ...
    @staticmethod
    def deleteInstances():
        for ins in Ui_PoseLibWin.instances:
            try:
            ...
            try:
                ...
                pass
            try:
                Ui_PoseLibWin.instances.remove(ins)
                del ins
            except:
                pass
    ...
    def setupUi(self):
        ...
        self.action_createFolder = QtWidgets.QAction(self)
    ...
    def retranslateUi(self, PoseLibWin):
        _translate = QtCore.QCoreApplication.translate
        PoseLibWin.setWindowTitle(_translate("PoseLibWin", "PoseLibrary"))
        self.treeWidget_folderList.headerItem().setText(0, _translate("PoseLibWin", "1"))
        __sortingEnabled = self.treeWidget_folderList.isSortingEnabled()
        self.treeWidget_folderList.setSortingEnabled(False)
        # self.treeWidget_folderList.topLevelItem(0).setText(0, _translate("PoseLibWin", "A"))
        # self.treeWidget_folderList.topLevelItem(0).child(0).setText(0, _translate("PoseLibWin", "TAMO AI"))
        # self.treeWidget_folderList.topLevelItem(0).child(1).setText(0, _translate("PoseLibWin", "NA MACIOTA"))
        self.treeWidget_folderList.setSortingEnabled(__sortingEnabled)
        self.groupBox_pose.setTitle(_translate("PoseLibWin", "Pose"))
        # self.button_snapShot.setText(_translate("PoseLibWin", "Icon"))
        self.label_poseLabel.setText(_translate("PoseLibWin", "Name"))
        self.button_blendValue.setText(_translate("PoseLibWin", "0"))
        self.button_save.setText(_translate("PoseLibWin", "Save"))
        self.action_createFolder.setText(_translate("PoseLibWin", "Create Folder"))
        self.action_expand.setText(_translate("PoseLibWin", "Expand"))
        self.action_collapse.setText(_translate("PoseLibWin", "Collapse"))
